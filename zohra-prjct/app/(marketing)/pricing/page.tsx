  ...
  return (
    <main className="min-h-screen bg-zinc-950 px-5 py-24 text-white sm:px-8 lg:px-12">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <p className="text-sm font-medium uppercase tracking-[0.2em] text-yellow-400">Pricing</p>
        <h1 className="text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
          Thoughtful pricing for focused work.
        </h1>
        <p className="max-w-2xl text-lg leading-8 text-zinc-400">
          Start with a simple plan that grows with your team and keeps the experience calm, clear, and premium.
        </p>
