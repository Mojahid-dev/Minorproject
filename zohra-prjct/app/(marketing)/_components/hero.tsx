...
const heroContent = {
  ...
  description:
    "Use this short space to explain the problem your project solves and why it matters. Keep it focused, helpful, and true to your voice.",
    ...
    <section className="relative isolate overflow-hidden bg-zinc-950 px-5 pb-12 pt-36 text-white sm:px-8 lg:min-h-screen lg:px-12 lg:pb-16 lg:pt-40">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center">
        <div className="mt-7 max-w-4xl text-center">
          <h2 className="text-balance text-4xl font-semibold tracking-[-0.055em] text-white sm:text-6xl lg:text-7xl">
            {heroContent.title}
            <span className="block bg-gradient-to-r from-yellow-200 via-yellow-500 to-amber-600 bg-clip-text text-transparent">
        ...
        <div className="mt-9 flex flex-col items-center gap-3 sm:flex-row">
          <Link
            href="/sign-up"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-yellow-500 px-5 py-3 text-sm font-semibold text-zinc-950 transition hover:scale-[1.02] hover:bg-yellow-400 sm:w-auto"
          >
          ...
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/[0.03] px-5 py-3 text-sm font-medium text-zinc-200 transition hover:border-yellow-500/40 hover:bg-white/[0.07] sm:w-auto"
          >
        ...
        <div
          id="product-preview"
          className="relative mt-14 w-full overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/70 p-2 shadow-[0_24px_90px_rgba(0,0,0,0.5)] sm:mt-16 sm:p-3"
        >
